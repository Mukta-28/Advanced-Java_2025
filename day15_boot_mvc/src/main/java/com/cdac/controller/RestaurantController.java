...
public class RestaurantController {
	 ...
	 * Model Atri- Annotation thet can be added on method arg
	 * meaning thisis to tell sc to bind the data/entity(restaurant entity-model-> form)
	 * i.e modelmap.addAttributr("restaurant",new restaurant)
	 */
	@GetMapping("/add_form")
	 ...
	 * -sc creates new resturant()
	 * -call setter on entity(n a c d)
	 */
	...
	/*
	 * handler method returns - redirect view name (redirect location )->D>S
	 * D.C->immidiately send temp redirect resp
	 * 
	 */
