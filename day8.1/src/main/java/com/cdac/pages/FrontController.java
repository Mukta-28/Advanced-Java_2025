...
public class FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "/update":
				...
				break;
			case "/add_user_form":
				showAddUserForm(request);
				viewName = prefix + "add_user_form" + suffix;
				break;
			case "/add":
				processAddUserForm(request);
				response.sendRedirect("./");
	...
	private void processAddUserForm(HttpServletRequest request) throws SQLException {
        ...
        // 5. (Optional) Store result in session/request for feedback
